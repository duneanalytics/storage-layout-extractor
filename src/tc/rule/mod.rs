...
use crate::{
    ...
    tc::{
        rule::{
            arithmetic_operations::ArithmeticOperationRule, bit_shifts::BitShiftRule,
            boolean_operations::BooleanOpsRule, call_data::CallDataRule,
            create::CreateContractRule, dynamic_array_write::DynamicArrayWriteRule,
            environment_opcodes::EnvironmentCodesRule, external_calls::ExternalCallRule,
            mapping_access::MappingAccessRule, masked_word::MaskedWordRule,
            offset_size::OffsetSizeRule, packed_encoding::PackedEncodingRule,
            s_load_is_inner_types::SLoadIsInnerTypesRule, sha3::HashRule,
            storage_key::StorageKeyRule, storage_write::StorageWriteRule,
        },
